...
// Limelight Fields
  ...
  public DriveToAmpCommand(DriveSubsystem drive) {
  ...
  public void execute() {
    ...
    {
      xError = tx.getDouble(0)-LimelightConstants.kAmpAimTX;
      yError = LimelightConstants.kAmpAimTY-ty.getDouble(0);
  ...
  public boolean isFinished() {
    if((Math.abs(xError)<LimelightConstants.tolerance && Math.abs(yError)<.5) && tx.getDouble(0)!=0) {
        return true;
    }
    return false;
  }
